...
public class SimpleTextExtractingPdfContentRenderListener implements TextProvidingRenderListener {
     ...
     * @see cljpdf.text.pdf.parser.RenderListener#renderText(String, GraphicsState, Rectangle)
     */

    /**
     * Captures text using a simplified algorithm for inserting hard returns and spaces
     * @see cljpdf.text.pdf.parser.AbstractRenderListener#renderText(java.lang.String, cljpdf.text.pdf.parser.GraphicsState, cljpdf.text.pdf.parser.Matrix, cljpdf.text.pdf.parser.Matrix)
     */
